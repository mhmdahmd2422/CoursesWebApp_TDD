            ...
            <div class="overflow-hidden rounded-lg lg:grid lg:grid-cols-2 lg:gap-4">
                ...
                <div class="order-2 md:order-1 p-8">
                    <div class="lg:self-center prose">
                        ...
                        <a href='#!' data-theme='none' data-items='[{"priceId": "{{$course->paddle_price_id}}","quantity": 1}]' class="paddle_button mt-8 inline-flex items-center rounded-md border border-transparent bg-yellow-400 py-3 px-6 text-base font-medium text-gray-900 shadow hover:text-red-500">Buy Now!</a>
                        <h3>Learnings</h3>
                        <ul>
