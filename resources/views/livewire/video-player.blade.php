    ...
    <div class="mx-auto max-w-7xl py-8">
        <div class="flex flex-col md:flex-row mx-4">
            ...
            <div class="w-full md:w-3/4 p-6 md:p-0">
                <iframe class="w-full aspect-video rounded mb-4 md:mb-4" src="https://player.vimeo.com/video/{{ $video->vimeo_id }}" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
