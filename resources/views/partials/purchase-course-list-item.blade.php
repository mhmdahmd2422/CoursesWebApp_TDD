<div class="space-y-4">
    <div class="aspect-w-3 aspect-h-2">
        <a class="text-indigo-600" href="{{ route('page.course-videos', $purchasedCourse) }}">
    ...
    <div class="space-y-2">
        <div class="space-y-1 text-lg font-medium leading-6">
            ...
            <a class="text-indigo-600" href="{{ route('page.course-videos', $purchasedCourse) }}">Watch videos</a>
        </div>
    </div>
</div>
